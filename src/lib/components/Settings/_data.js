 ...
 */
export const settingsDefault = '011101000'
...
export const settingsData = [
  ...
  { index: 8, name: 'Recommendation Method', help: 'Default recommendation calculation method for boss battles', options: [ 'Basic', 'Advanced' ]},
  { index: 999,
    name: 'Greenscreen',
